...
namespace Whistle.Views
{
	public class SlideMenu : FrameLayout
	{
		bool opened;
		int contentOffsetX;
		...
		public SlideMenu (Context context, IAttributeSet attrs) :
			base (context, attrs)
		{
			Initialize ();
		}

		public SlideMenu (Context context, IAttributeSet attrs, int defStyle) :
