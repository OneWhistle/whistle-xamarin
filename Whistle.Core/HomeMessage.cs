...
namespace Whistle.Core
{
    public sealed class HomeConstants
    {
        ...
        public const string NAV_CONTACT_WHISTLER = "{0A5FF4C8-C767-4B69-8A2B-FD11A3553BF9}";
        public const string NAV_WHISTLE_DISPLAY = "NAV_WHISTLE_DISPLAY";
        public const string NAV_CLEAR_SELECTED_WHISTLER = "NAV_CLEAR_SELECTED_WHISTLER";
